var canvas1 = document.getElementById('canvas_effect_thunderstorm1');
var canvas2 = document.getElementById('canvas_effect_thunderstorm2');
var canvas3 = document.getElementById('canvas_effect_thunderstorm3');
...
var w = canvas1.width = canvas2.width = canvas3.width = $('#map-preview').width();
var h = canvas1.height = canvas2.height = canvas3.height = $('#map-preview').height();
window.addEventListener('resize', function () {
    resizeThunderstormCanvas()
});
...
function resizeThunderstormCanvas(){
    w = canvas1.width = canvas2.width = canvas3.width = $('#map-preview').width();
    h = canvas1.height = canvas2.height = canvas3.height = $('#map-preview').height();
}

setInterval(resizeThunderstormCanvas, 30);
